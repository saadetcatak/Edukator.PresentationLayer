...
namespace Edukator.PresentationLayer.Controllers
{
    public class StatisticController : Controller
    {
        public IActionResult Index()
        {
            ...
            ViewBag.lastCourseTitle=context.Courses.Where(x=>x.CourseID==(context.Courses.Max(y=>y.CourseID))).Select(y=>y.Title).FirstOrDefault();
            ...
            ViewBag.last3CourseTotalPrice=context.Courses.OrderByDescending(x=>x.CourseID).Take(3).Sum(w=>w.Price);
